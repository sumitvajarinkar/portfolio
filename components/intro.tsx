    ...
    >
      ...
      >
        ...
        <a
          ...
          href="https://drive.google.com/file/d/1pkJjDMGcB30kSJbVnibv7jMC4nm82xM4/view?usp=drivesdk"
          target="_blank"
        >
          Resume{" "}
          <GoMoveToEnd className="opacity-60 group-hover:translate-x-1 transition" />
        </a>
 <motion.div className="flex sm:flex-row"
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
            delay: 0.1,
        ...
        <a
          ...
          href="https://github.com/sumitvajarinkar"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://leetcode.com/vsumit17/"
          target="_blank"
        >
          <SiLeetcode />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://codeforces.com/profile/vsumit17"
          target="_blank"
        >
          <SiCodeforces />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://auth.geeksforgeeks.org/user/vsumit17"
          target="_blank"
        >
          <SiGeeksforgeeks />
        </a>
